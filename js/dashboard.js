...
var channelKeys =[];
channelKeys.push({channelNumber:164534, name:'Living Room',key:'XXXXXXXXXXXXXXXX',
                  fieldList:[{field:1,axis:'T'},{field:2,axis:'H'},{field:3, axis:'P'}]});
...
$(document).ready(function()
{
 ...
 function createChart() {
  ...
  var chartOptions = {
    ...
    yAxis: [
      { id: 'T', title: { text: 'Temperature °C' }, opposite: false, lineWidth: 1 },
      { id: 'H', title: { text: 'Relative Humidity %' }, opposite: true, lineWidth: 1 },
      { id: 'P', title: { text: 'Pressure (hPa)' }, opposite: true }
    ],
    exporting: {
      enabled: true,
      csv: {
